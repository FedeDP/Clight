...
static void parse_cmd(int argc, char *const argv[]) {
    ...
    const struct poptOption po[] = {
        ...
        {"no-gamma-smooth-transition", 0, POPT_ARG_NONE, &conf.no_gamma_smooth_transition, 100, "Disable smooth gamma transition", NULL},
        {"no-dimmer-smooth-transition", 0, POPT_ARG_NONE, &conf.no_dimmer_smooth_transition, 100, "Disable smooth dimmer transition", NULL},
