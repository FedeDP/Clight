...
complete -c clight -o b -r -d "Path to backlight syspath. If empty, first matching device is used"
complete -c clight -l backlight -r -d "Path to backlight syspath. If empty, first matching device is used"
